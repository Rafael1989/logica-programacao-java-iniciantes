...
public class ContatosControle {
	...
	public ModelAndView editar(@PathVariable String id) {
		logger.info("Acessando editar para id: " + id);
		ModelAndView modelAndView = new ModelAndView("formulario");
		
		Contato contato = procurarContato(id);
		logger.info("Contato encontrado: " + (contato != null ? contato.getNome() : "null"));
	...
	public String atualizar(@PathVariable String id, Contato contato) {
		logger.info("Atualizando contato id: " + id + ", nome: " + contato.getNome());
		Integer indiceContato = procurarIndiceContato(id);
		
		if (indiceContato != null) {
			LISTA_CONTATOS.remove(indiceContato.intValue());
			contato.setId(id);
			LISTA_CONTATOS.add(indiceContato, contato);
			logger.info("Contato atualizado com sucesso");
		} else {
			logger.warn("Contato não encontrado para atualizar: " + id);
		}
	...
	public String remover(@PathVariable String id) {
		logger.info("Removendo contato id: " + id);
		Contato contato = procurarContato(id);
		...
		if (contato != null) {
			...
			logger.warn("Contato não encontrado para remover: " + id);
		}
